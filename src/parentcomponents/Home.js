...
export default function Home()
{
  ...
  const generateShortUrl = async (e) => {
    ...
    try {
      ...
      axios.post('https://url-shortener-beu2.onrender.com/shortUrl', { "useremail":useremail,"shortenedUrl":shortUrl }, { headers: { 'Content-Type': 'application/json' } })
      .then((response) => {
  ...
  function displaygeneratedUrl()
  {
    ...
    axios.get(`https://url-shortener-beu2.onrender.com/viewshortUrl/${useremail}`)
    .then((res )=>{
