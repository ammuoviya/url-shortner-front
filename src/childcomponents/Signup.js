...
export default function Signup()
{
  ...
  {
    axios.post('https://url-shortener-beu2.onrender.com/createUsers', {"username":username, "useremail":email,"password":password }, { headers: { 'Content-Type': 'application/json' } })
            .then((response) => {
