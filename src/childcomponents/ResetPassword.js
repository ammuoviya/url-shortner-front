...
export  default function Resetpassword()
{
    ...
    function updatePassword()
    {
        ...
        axios.post('https://url-shortener-beu2.onrender.com/reset-password', {"useremail":emailId,"resetToken":token,"newPassword":newPassword }, { headers: { 'Content-Type': 'application/json' } })
        .then((response) => {
